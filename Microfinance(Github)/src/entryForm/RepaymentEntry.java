...
public class RepaymentEntry extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RepaymentEntry frame = new RepaymentEntry("Group");
	 ...
	 * Create the frame.
	 */
	public RepaymentEntry(String form) {
		Initialize();
...
//				ViewClientDetails("M4");
		...
		panel_1.add(textField_1, "cell 3 2 2 1,growx");
		...
		panel_1.add(textField_2, "cell 3 3 2 1,growx");
		...
		panel_1.add(textField_4, "cell 3 4 2 1,growx");
		...
		panel_1.add(textField_3, "cell 3 5 2 1,growx");
