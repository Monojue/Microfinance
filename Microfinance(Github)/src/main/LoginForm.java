...
public class LoginForm extends JFrame {
	...
	public void Initialize() {
		...
		panel.setLayout(new MigLayout("", "[30][60][60][181px,grow][56.00px][60][30]", "[45.00][43px][20px][51.00][29px][16.00][29px:29px][25.00][21px]"));
